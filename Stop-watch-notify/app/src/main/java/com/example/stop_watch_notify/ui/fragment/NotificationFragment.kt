...
class NotificationFragment : ListFragment<Notification, NotificationVH>() {
    ...
    override fun onCreateView(
        ...
        val notificationList = DataType.NOTIFICATIONS.dataList as MutableList<Notification>
                    ...
                    R.id.action_delete -> {
                        ...
                        dialogFragment.setOptions(
                            ...
                            "No",
                            {
                                ...
                                adapter.updateList(DataType.NOTIFICATIONS.dataList as MutableList<Notification>)
                            },
                            null
                        )
        ...
        addButton.setOnClickListener {
            ...
            dialogFragment.setOptions(
                ...
                var notification = Notification(
                    DataProvider.findSmallestUnusedIndex(DataType.NOTIFICATIONS),
                    time,
                    true,
                    -1
                )
                DataProvider.addNotification(
                    DataType.NOTIFICATIONS,
                    notification,
                    requireContext()
                )
